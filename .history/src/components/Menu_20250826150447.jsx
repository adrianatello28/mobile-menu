      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            >
              <motion.div className="menu__content" variants={staggerContainer}>
                <motion.h1 className="menu__title" variants={slideDown}>
                  A conta completa <br />
                  do Mercado Livre
                </motion.h1>
                <motion.div className="menu__menu-all" variants={slideDown}>
              ...
              <motion.div className="menu__bottom-cta" variants={slideDown}>
