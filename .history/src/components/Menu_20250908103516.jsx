...
import './Menu.css';
import item1 from '/src/assets/images/Item 2.png';
...
const Menu = () => {
  ...
  const [showCtaShadow, setShowCtaShadow] = useState(false);
              ...
              <AnimatePresence>
                {view === 'digital' && (
                  <motion.div
                    ...
                    exit="exit"
                  >
                    <SubMenu onBack={goBack} onSelectItem={showDetail} onScrollChange={setShowCtaShadow} />
                  </motion.div>
                )}
                ...
                {view === 'negocio' && (
                  <motion.div
                    ...
                    exit="exit"
                  >
                    <ContaNegocio onBack={goBack} onSelectItem={showDetail} onScrollChange={setShowCtaShadow} />
                  </motion.div>
                )}
                ...
                {view === 'detail' && (
                  <motion.div
                    ...
                    exit="exit"
                  >
                    <SubMenuDetail title={detailTitle} onBack={goBack} onScrollChange={setShowCtaShadow} />
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
            <div className={`menu__bottom-cta ${showCtaShadow ? 'menu__bottom-cta--with-shadow' : ''}`}>
